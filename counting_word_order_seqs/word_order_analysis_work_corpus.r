...
# saves directory
current_dir = getwd()
results_dir = file.path(current_dir,"Updated_Results")

# creates folder if it doesn't exist
if (!dir.exists("Updated_Results")) {dir.create("Updated_Results")}
...
data = read.csv2("exported_participant_roles_analyzed_data.csv",stringsAsFactors=FALSE) %>% as_tibble
data
...
setA = subset(data, Segment..Segment_set == "SetA")
setB = subset(data, Segment..Segment_set == "SetB")
...
write_csv2(data,"updated_final_data_with_sequence.csv")
write_csv2(sequence_counts,"sequence_final_counts.csv")

# counts and proportions of sequences
write_csv2(sequence_rates_setA,"final_sequence_rates_setA.csv")
write_csv2(sequence_rates_setB,"final_sequence_rates_setB.csv")
